...
## 프로젝트 소개
학생 정보를 이진 탐색 트리(BST)로 관리하는 프로그램이다.
...
| 이름 | 역할 |
|------|------|
| 원종찬 | 자료구조 설계, 주요 기능 구현, UI 담당, 발표 자료 준비 |
| 주예서 | 자료구조 설계, 알고리즘 구현, 주요 기능 구현, UI 담당, GitHub 관리, 보고서 작성 |
...
│
├── docs/
│   ├── 자료구조 팀 프로젝트 제안서 (원종찬, 주예서).pdf
│   ├── 자료구조 팀 프로젝트 보고서 (원종찬, 주예서).pdf
│   └── 자료구조 팀 프로젝트 발표자료 (원종찬, 주예서).pdf
│
├── data/
│   └── sample_students.txt
│
